...
#
tSrcArchive = tarfile.open('neturl-1.1-1.tar.gz', 'r')
tSrcArchive.extractall('targets/depack')
tSrcArchive.close()
strDepackPath = 'targets/depack/neturl-1.1-1/'
...
tArcList.AddFiles('lua/net/',
                  os.path.join(strDepackPath, 'lib', 'net', 'url.lua'))
